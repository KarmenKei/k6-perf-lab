...
5 VU-ийн үед системийн p95 latency 272.32 ms байсан бөгөөд энэ нь baseline гүйцэтгэлийн үзүүлэлт. Ачааллыг 30 VU хүртэл нэмэгдүүлэхэд throughput 7.40 req/s-ээс 45.47 req/s болж мэдэгдэхүйцээр өссөн ба үүний зэрэгцээ p95 latency 272.32 ms-ээс 231.38 ms болж буурав. 100 VU-ийн үед throughput 150.42 req/s хүрсэн бөгөөд p95 latency 232.14 ms байсан. Иймээс энэ туршилтын хүрээнд хэрэглэгчийн тоо өсөхөд throughput нэмэгдсэн боловч latency огцом өсөөгүй, харьцангуй тогтвортой хэвээр байв. Мөн 5, 30, 100 VU-ийн бүх түвшинд error rate 0.00% байсан нь туршилтын явцад хүсэлтүүд амжилттай боловсруулагдсаныг харуулж байна. Энэ нь throughput, latency болон error rate нь системийн ачаалалтай хэрхэн холбоотойг бодитоор хэмжих эсэхийг олгов. Stages тестээр ачааллыг 5 -> 30 -> 100 VU болгон өсгөж, дараа нь бууруулах үеийн системийн ерөнхий гүйцэтгэлийг ажиглав. Baseline-д үндэслэн тодорхойлсон p95 < 408 ms болон error rate < 1% гэсэн SLO нь PASS тестээр хангагдсан. Харин p95 < 50 ms гэсэн санаатайгаар хатуу threshold нь FAIL болсон нь k6-г performance quality gate болгон ашиглаж болохыг харуулсан.
