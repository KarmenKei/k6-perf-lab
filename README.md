...
Baseline-ийн p95 утгыг үндэслэн ачаалал нэмэгдэх үед бага хэмжээний хэлбэлзэл гарах боломжийг тооцож, SLO-ийн latency босгыг baseline-ийн **1.5 дахин** буюу **343.77 ms** дээр тогтов.

* **Latency SLO:** `p95 < 343.77 ms`
* **Error rate SLO:** `< 1%`
